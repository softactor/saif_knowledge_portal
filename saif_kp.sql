...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 07, 2019 at 06:53 AM
...
--
-- Table structure for table `addr_districts`
--
...
--
-- Dumping data for table `addr_districts`
--

INSERT INTO `addr_districts` (`id`, `division_id`, `name`, `bn_name`, `lat`, `lon`, `website`) VALUES
...
--
-- Table structure for table `addr_divisions`
--

CREATE TABLE `addr_divisions` (
  `id` int(2) UNSIGNED NOT NULL,
  `name` varchar(30) NOT NULL,
  `bn_name` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `addr_divisions`
--

INSERT INTO `addr_divisions` (`id`, `name`, `bn_name`) VALUES
(1, 'Barishal', 'বরিশাল'),
...
--
-- Table structure for table `addr_unions`
--

CREATE TABLE `addr_unions` (
  `id` int(2) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `addr_unions`
--

INSERT INTO `addr_unions` (`id`, `upazila_id`, `name`, `bn_name`, `lat`, `lon`) VALUES
(1, 226, '', 'আমলাব', 0, 0),
(2, 226, '', 'বাজনাব', 0, 0),
(3, 226, '', 'বেলাব', 0, 0),
...
--
-- Table structure for table `addr_upazilas`
--

CREATE TABLE `addr_upazilas` (
  `id` int(2) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `addr_upazilas`
--

INSERT INTO `addr_upazilas` (`id`, `district_id`, `name`, `bn_name`) VALUES
...
(1, 1, 1, 'Tanveer', 'Qureshee', 5, 18, 0, 0, '2019-11-15', '', '0171558899', 0, 0, 0, '0000-00-00', '0000-00-00 00:00:00', 1),
(2, 5, 1, 'Jalil', 'Ahmed', 2, 42, 0, 0, '2019-11-25', '', '01546789555', 0, 0, 0, '0000-00-00', '0000-00-00 00:00:00', 1);
...
(7, 'Blueline communication Ltd'),
(8, 'Saif Sporting Club');
...
INSERT INTO `faq` (`id`, `division_id`, `question_title`, `question_answer`, `question_tag`, `user_id`) VALUES
(4, 1, 'What is a Battery?', '<p>A battery, can be any device that stores energy for later use. The word battery, is limited to an electrochemical device that converts chemical energy into electricity, by use of a galvanic cell. A galvanic cell is a fairly simple device consisting of two electrodes (an anode and a cathode) and an electrolyte solution. Batteries consist of one or more galvanic cells.</p>\r\n', 'battery', NULL),
(5, 1, 'How long will my battery last?', '<p>The lifespan of a battery will vary considerably with how it is used, how it is maintained and charged, temperature, and other factors.</p>\r\n', 'battery,ifespan', NULL),
(6, 1, 'What is a Deep Cycle Battery?', '<p>Deep cycle batteries are designed to be discharged down as much as 80% time after time, and have much thicker plates that a standard automotive battery.</p>\r\n', 'Deep Cycle Battery', NULL),
(7, 4, 'What is the brand name?', '<p>TEKSAN.</p>\r\n', '', NULL),
(8, 4, 'What is the capacity range for diesel generator? ', '<p>Our generators cover the capacity which rating from 7KVA to 2500 KVA.</p>\r\n', '', NULL),
(9, 4, 'What is the country of origin for generator?', '<p>Turkey, Europe.</p>\r\n', '', NULL),
(10, 4, 'What is the engine brand and its origin for TEKSAN?', '<p>We provide 3 types of engine.</p>\r\n\r\n<table align=\"right\" cellspacing=\"0\" style=\"border-collapse:collapse\">\r\n	<tbody>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:1px solid black; vertical-align:top; width:296px\">\r\n			<p><strong>Brand Name</strong></p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:1px solid black; vertical-align:top; width:295px\">\r\n			<p><strong>Country of Origin</strong></p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; vertical-align:top; width:296px\">\r\n			<p>Perkins</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:295px\">\r\n			<p>United Kingdom</p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; vertical-align:top; width:296px\">\r\n			<p>Doosan</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:295px\">\r\n			<p>South Korea</p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; vertical-align:top; width:296px\">\r\n			<p>Baudouin</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:295px\">\r\n			<p>China</p>\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n', '', NULL),
(11, 4, 'What is the alternator brand and its origin?', '<table cellspacing=\"0\" style=\"border-collapse:collapse\">\r\n	<tbody>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:1px solid black; vertical-align:top; width:295px\">\r\n			<p><strong>Brand Name</strong></p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:1px solid black; vertical-align:top; width:295px\">\r\n			<p><strong>Country of Origin</strong></p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; vertical-align:top; width:295px\">\r\n			<p>Marelli</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:295px\">\r\n			<p>Italy</p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; vertical-align:top; width:295px\">\r\n			<p>Stamford</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:295px\">\r\n			<p>United Kingdom</p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; vertical-align:top; width:295px\">\r\n			<p>Leroy Somer</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:295px\">\r\n			<p>Czech Republic</p>\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n', '', NULL),
(12, 4, 'What is the controller brand and its origin?', '<p>We provide two types of controller.</p>\r\n\r\n<table cellspacing=\"0\" style=\"border-collapse:collapse\">\r\n	<tbody>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:1px solid black; vertical-align:top; width:295px\">\r\n			<p><strong>Brand Name</strong></p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:1px solid black; vertical-align:top; width:295px\">\r\n			<p><strong>Country of Origin</strong></p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; vertical-align:top; width:295px\">\r\n			<p>Datacom (Teksan)</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:295px\">\r\n			<p>Turkey</p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; vertical-align:top; width:295px\">\r\n			<p>Deep Sea</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:295px\">\r\n			<p>United Kingdom</p>\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n', '', NULL),
(13, 4, ' Is ready stock available?', '<p>Ready stock available from 10KVA to 700KVA.</p>\r\n', 'generator', NULL),
(14, 4, 'From where the machine is shipped?', '<p>Istanbul, Turkey.&nbsp;</p>\r\n', '', NULL),
(15, 4, 'Is spare parts available? ', '<p>We maintain a considerable collection of genuine spare parts matching different DG models. However, for special parts it is better to notice us earlier. First moving consumable spare parts is readily available but in case of slow moving or special parts , it will little take some time depending on the parts stock availability from manufacturer end.</p>\r\n', '', NULL),
(16, 4, 'What will be the warranty?', '<p>12 months from the date of delivery.</p>\r\n\r\n<p>Warranty does not cover:</p>\r\n\r\n<ul>\r\n	<li>Defects due to user&rsquo;s improper maintenance.</li>\r\n	<li>All consumable items.</li>\r\n	<li>Diode and surge suppressor failure.</li>\r\n	<li>Normal wear and tear.</li>\r\n</ul>\r\n\r\n<p>Alternations or repairs mot authorized by manufacturer in writing.</p>\r\n', '', NULL),
(17, 4, 'What will be the after sales service?', '<p>After sales service is free for 12 months from the date of commissioning without consumable spare parts.</p>\r\n', '', NULL),
(18, 4, 'How many generators you have in the market?', '<p>1000 Plus</p>\r\n', '', NULL),
(19, 4, '11. What will be the after sales service?', '<p>&nbsp;After sales service is free for 12 months from the date of commissioning without consumable spare parts.</p>\r\n', 'Generator', NULL),
(20, 4, 'What is the capacity range for excavator? ', '<p>Our excavator covers the capacity which weights from 2.7 Tons to 51 Tons. For bucket capacity its starts from 0.08 cu.m to 4.5 cu.m.</p>\r\n', 'Excavator', NULL),
(21, 4, 'What is the brand name of Excavator?', '<p>Doosan.</p>\r\n', 'Excavator', NULL),
(22, 4, 'What is the country of origin of Excavator?', '<p>South Korea.</p>\r\n', 'Excavator', NULL),
(23, 4, 'What is the engine brand and its origin of Excavator?', '<p>Engine is manufactured by Doosan and origin is in South Korea.</p>\r\n', 'Excavator', NULL),
(24, 4, 'Is wheeled excavator available?', '<p>Yes, we have wheeled excavators from 5 Tons to 20 Tons capacity.</p>\r\n', 'Excavator', NULL),
(25, 4, 'What is the hydraulic pump brand and its origin?', '<p>Hydraulic pump is manufactured by Doosan and origin is in South Korea.</p>\r\n', 'Excavator', NULL),
(26, 4, 'Is it available with attachments of Excavator?', '<p>Yes, the following attachments are available:</p>\r\n\r\n<ul>\r\n	<li>Quick coupler.</li>\r\n	<li>Hydraulic breaker.</li>\r\n	<li>Ripper</li>\r\n</ul>\r\n\r\n<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</p>\r\n', 'Excavator', NULL),
(27, 4, 'Is ready stock available of Excavator?', '<p>Ready stock not available.</p>\r\n', 'Excavator', NULL),
(28, 4, 'From where the machine is shipped (Excavator)?', '<p>South Korea.</p>\r\n', 'Excavator', NULL),
(29, 4, 'Is spare parts available for Excavator? ', '<p>We maintain a considerable collection of genuine spare parts matching different excavator models. However, for special parts it is better to notice us earlier. First moving consumable spare parts is readily available but in case of slow moving or special parts, it will little take some time depending on the parts stock availability from manufacturer end.</p>\r\n', 'Excavator', NULL),
(30, 4, 'What will be the warranty (Excavator)?', '<p>Warranty will be provided only for the manufacturer defects supplied Excavator and period will be 12 months or 1500 running hours from the&nbsp; date of commissioning which occurs first, provided that the diesel Excavator will be operated in accordance with our O&amp;M manual and will be maintained in accordance with our overhaul schedule.</p>\r\n\r\n<p>Warranty does not cover:</p>\r\n\r\n<ul>\r\n	<li>Defects due to user&rsquo;s improper maintenance.</li>\r\n	<li>All consumable items.</li>\r\n	<li>Hose pipe and electrical failure.</li>\r\n	<li>Normal wear and tear.</li>\r\n	<li>Alternations or repairs mot authorized by manufacturer in writing.<br />\r\n	&nbsp;</li>\r\n</ul>\r\n', 'Excavator', NULL),
(31, 4, 'What will be the after sales service( Excavator)?', '<p>After sales service is free for 12 months from the date of commissioning without consumable spare parts.</p>\r\n', 'Excavator', NULL),
(32, 4, 'How many excavators you have in the market?', '<p>65 Plus.&nbsp;</p>\r\n', 'Excavator', NULL),
(33, 4, 'What is the capacity range for fork lift? ', '<p>Our fork lifts cover the capacity which weights from 2 Tons to 10 Tons. If we consider by lifting heights its can lift from 3m to 6m.&nbsp;&nbsp;</p>\r\n', 'Forklift', NULL),
(34, 4, 'What is the brand name of Forklift?', '<p>We are currently working with 2 brands. Zoomlion &amp; Doosan.</p>\r\n', 'Forklift', NULL),
(35, 4, 'What is the country of origin?', '<p>South Korea for Doosan and China for Zoomlion.</p>\r\n\r\n<table cellspacing=\"0\" style=\"border-collapse:collapse\">\r\n	<tbody>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:1px solid black; vertical-align:top; width:312px\">\r\n			<p>Brand</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:1px solid black; vertical-align:top; width:312px\">\r\n			<p>Origin</p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; vertical-align:top; width:312px\">\r\n			<p>Doosan</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:312px\">\r\n			<p>South Korea&nbsp;</p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; vertical-align:top; width:312px\">\r\n			<p>Zoomlion</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:312px\">\r\n			<p>China</p>\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n', 'Forklift', NULL),
(36, 4, 'What is the country of manufacturing?', '<p>:</p>\r\n\r\n<table cellspacing=\"0\" style=\"border-collapse:collapse\">\r\n	<tbody>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:1px solid black; vertical-align:top; width:312px\">\r\n			<p>Brand</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:1px solid black; vertical-align:top; width:312px\">\r\n			<p>Manufacturing Country</p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; vertical-align:top; width:312px\">\r\n			<p>Zoomlion (From 2 Tons to 10 Tons)</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:312px\">\r\n			<p>China</p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; vertical-align:top; width:312px\">\r\n			<p>Doosan (From 2 Tons to 3 Tons)</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:312px\">\r\n			<p>China</p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; vertical-align:top; width:312px\">\r\n			<p>Doosan (From 1.5 Tons to 5.5 Tons)</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:312px\">\r\n			<p>South Korea</p>\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n', 'Forklift', NULL),
(37, 4, 'What is the engine brand and its origin (Forklift)?', '<p>Engine is manufactured by Doosan and origin is in South Korea. (Korean Doosan)<br />\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Engine brands are Yanmar and origin is in Japan. (China Doosan)<br />\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Engine brand is Isuzu, Mitsubishi and origin is in Japan. (For Zoomlion)</p>\r\n\r\n<table cellspacing=\"0\" style=\"border-collapse:collapse\">\r\n	<tbody>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:1px solid black; vertical-align:top; width:211px\">\r\n			<p>Brand</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:1px solid black; vertical-align:top; width:208px\">\r\n			<p>Engine Manufacturer</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:1px solid black; vertical-align:top; width:204px\">\r\n			<p>Manufacturing Country</p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; vertical-align:top; width:211px\">\r\n			<p>Zoomlion (From 2 Tons to 10 Tons)</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:208px\">\r\n			<p>Isuzu, Mitsubishi</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:204px\">\r\n			<p>Japan</p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; vertical-align:top; width:211px\">\r\n			<p>Doosan (From 2 Tons to 3 Tons)</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:208px\">\r\n			<p>Yanmar</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:204px\">\r\n			<p>Japan</p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; vertical-align:top; width:211px\">\r\n			<p>Doosan (From 1.5 Tons to 5.5 Tons)</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:208px\">\r\n			<p>Doosan</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:204px\">\r\n			<p>South Korea</p>\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n\r\n<p><br />\r\n<br />\r\n&nbsp;</p>\r\n', 'Forklift', NULL),
(38, 4, 'What is the hydraulic pump brand and its origin for forklift?', '<p>Hydraulic pump is manufactured by Doosan and origin is in South Korea. (Korean and China Doosan)<br />\r\nHydraulic pump brand is Shimezue and origin is in Japan.<br />\r\n&nbsp;</p>\r\n\r\n<table cellspacing=\"0\" style=\"border-collapse:collapse\">\r\n	<tbody>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:1px solid black; vertical-align:top; width:211px\">\r\n			<p>Brand</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:1px solid black; vertical-align:top; width:208px\">\r\n			<p>Engine Manufacturer</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:1px solid black; vertical-align:top; width:204px\">\r\n			<p>Manufacturing Country</p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; vertical-align:top; width:211px\">\r\n			<p>Zoomlion (From 2 Tons to 10 Tons)</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:208px\">\r\n			<p>Shimezue</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:204px\">\r\n			<p>Japan</p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; vertical-align:top; width:211px\">\r\n			<p>Doosan (From 2 Tons to 3 Tons)</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:208px\">\r\n			<p>Doosan</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:204px\">\r\n			<p>South Korea</p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; vertical-align:top; width:211px\">\r\n			<p>Doosan (From 1.5 Tons to 5.5 Tons)</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:208px\">\r\n			<p>Doosan</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:204px\">\r\n			<p>South Korea</p>\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n', 'Forklift', NULL),
(39, 4, 'Is ready stock available of forklift?', '<p>Ready stock available for 2 tons to 5 tons standard.</p>\r\n', 'Forklift', NULL),
(40, 4, 'From where the machine is shipped (Forklift)?', '<p>:</p>\r\n\r\n<table cellspacing=\"0\" style=\"border-collapse:collapse\">\r\n	<tbody>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:1px solid black; vertical-align:top; width:312px\">\r\n			<p>Brand</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:1px solid black; vertical-align:top; width:312px\">\r\n			<p>Shipment From</p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; vertical-align:top; width:312px\">\r\n			<p>Zoomlion (From 2 Tons to 10 Tons)</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:312px\">\r\n			<p>China</p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; vertical-align:top; width:312px\">\r\n			<p>Doosan (From 2 Tons to 3 Tons)</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:312px\">\r\n			<p>China</p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style=\"border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; vertical-align:top; width:312px\">\r\n			<p>Doosan (From 1.5 Tons to 5.5 Tons)</p>\r\n			</td>\r\n			<td style=\"border-bottom:1px solid black; border-left:none; border-right:1px solid black; border-top:none; vertical-align:top; width:312px\">\r\n			<p>South Korea</p>\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n\r\n<p>&nbsp;</p>\r\n', 'Forklift', NULL),
(41, 4, 'Is spare parts available for forklift ? ', '<p>We maintain a considerable collection of genuine spare parts matching different excavator models. However, for special parts it is better to notice us earlier. First moving consumable spare parts is readily available but in case of slow moving or special parts, it will little take some time depending on the parts stock availability from manufacturer end.</p>\r\n', 'Forklift', NULL),
(42, 4, 'What will be the warranty for forklift?', '<p>Warranty will be provided only for the manufacturer defects supplied Excavator and period will be 12 months or 1500 running hours from the&nbsp; date of commissioning which occurs first, provided that the diesel Excavator will be operated in accordance with our O&amp;M manual and will be maintained in accordance with our overhaul schedule.</p>\r\n\r\n<p>Warranty does not cover:</p>\r\n\r\n<ul>\r\n	<li>Defects due to user&rsquo;s improper maintenance.</li>\r\n	<li>All consumable items.</li>\r\n	<li>Hose pipe and electrical failure.</li>\r\n	<li>Normal wear and tear.</li>\r\n	<li>Alternations or repairs mot authorized by manufacturer in writing.<br />\r\n	&nbsp;</li>\r\n</ul>\r\n', 'Forklift', NULL),
(43, 4, 'What will be the after sales service for Forklift?', '<p>After sales service is free for 12 months from the date of commissioning without consumable spare parts.</p>\r\n', 'Forklift', NULL),
(44, 4, 'How many Forklift you have in the market ?', '<p>400 Plus for Zoomlion.<br />\r\n150 Plus for Doosan. &nbsp;&nbsp;</p>\r\n', 'Forklift', NULL),
(45, 4, 'What is the capacity range for wheel loader? ', '<p>&nbsp;Our wheel loader covers the capacity which weights from 11 Tons to 30 Tons. For bucket capacity it starts from 2.00 cu.m to 5.7 cu.m</p>\r\n', 'Wheel  Loader', NULL),
(46, 4, 'What is the brand name of Wheel Loader?', '<p>Doosan.</p>\r\n', 'Wheel  Loader', NULL),
(47, 4, 'What is the country of origin (Wheel Loader)?', '<p>South Korea.</p>\r\n', 'Wheel  Loader', NULL),
(48, 4, 'What is the engine brand and its origin for Wheel Loader?', '<p>Engine is manufactured by Doosan and origin is in South Korea.&nbsp;</p>\r\n', 'Wheel  Loader', NULL),
(49, 4, 'What is the hydraulic pump brand and its origin for wheel loader?', '<p>Hydraulic pump is manufactured by Doosan and origin is in South Korea</p>\r\n', 'Wheel  Loader', NULL),
(50, 4, 'Is ready stock available for Wheel Loader? ', '<p>Ready stock not available.</p>\r\n', 'Wheel  Loader', NULL),
(51, 4, 'From where the machine is shipped (Wheel Loader)? ', '<p>South Korea</p>\r\n', 'Wheel  Loader', NULL),
(52, 4, 'Is spare parts available for wheel loader? ', '<p>We maintain a considerable collection of genuine spare parts matching different excavator models. However, for special parts it is better to notice us earlier. First moving consumable spare parts is readily available but in case of slow moving or special parts, it will little take some time depending on the parts stock availability from manufacturer end.&nbsp;</p>\r\n', 'Wheel  Loader', NULL),
(53, 4, 'What will be the warranty for Wheel loader? ', '<p>Warranty will be provided only for the manufacturer defects supplied Excavator and period will be 12 months or 1500 running hours from the &nbsp;date of commissioning which occurs first, provided that the diesel Excavator will be operated in accordance with our O&amp;M manual and will be maintained in accordance with our overhaul schedule.</p>\r\n\r\n<p>Warranty does not cover:&nbsp;<br />\r\n&bull; Defects due to user&rsquo;s improper maintenance. &bull; All consumable items. &bull; Hose pipe and electrical failure.&nbsp;<br />\r\n&bull; Normal wear and tear. &bull; Alternations or repairs mot authorized by manufacturer in writing.&nbsp;</p>\r\n', 'Wheel  Loader', NULL),
(54, 4, 'What will be the after sales service for wheel loader? ', '<p>After sales service is free for 12 months from the date of commissioning without consumable spare parts.&nbsp;</p>\r\n', 'Wheel  Loader', NULL),
(55, 4, 'How many Wheel loader you have in the market? ', '<p>17 Plus.&nbsp;</p>\r\n', 'Wheel  Loader', NULL),
(56, 5, 'What is the capacity of Batching Plant?', '<p>35m3/hour</p>\r\n', 'Batching Plant', NULL);
...
CREATE TABLE `product_info` (
  ...
  `excel_path` varchar(600) DEFAULT NULL,
  `pdf_path` varchar(600) DEFAULT NULL,
...
INSERT INTO `product_info` (`id`, `division_id`, `product_title`, `description`, `image_path`, `excel_path`, `pdf_path`, `tag`, `product_type`, `user_id`) VALUES
(5, 1, 'PASSENGER CAR (PC) - SEALED MAINTENANCE FREE (SMF) BATTERY', '<p><strong>Product Info:</strong><br />\r\nIGNITE is a Sealed Maintenance Free (SMF) Battery for Passenger Cars (PC) which is the ultimate in battery performance and technology. Featuring special internal components, unique design features and leading technologies to deliver what car enthusiasts really want.&nbsp;<br />\r\n&nbsp;</p>\r\n\r\n<p><strong>Features and Benefits:</strong></p>\r\n\r\n<ul>\r\n	<li><a href=\"http://saifpowertecltd.com/ignite-pc-smf.php\">Special Calcium alloy makes the battery capability superior for Maintenance Free (MF) operation.</a></li>\r\n	<li>Advanced grid design improves the adherence of active material for corrosion resistance and longer life of battery.</li>\r\n	<li>Automated Cast on strap (COS) machine is used for group burning.</li>\r\n	<li>Advanced grid design improves the adherence of active material for corrosion resistance and longer life of battery.</li>\r\n	<li>Specified thickness and weight of plate provides proper service life and operation.</li>\r\n	<li>High porosity and very low resistance PEGM Separator reduces the internal resistance of battery and ensure proper utilization of electrolyte and Battery service life.</li>\r\n	<li>Manufactured with new, advanced and world class European and USA machineries.</li>\r\n	<li>First time in Bangladesh use of modern methodology of Lead Testing by ICP-OES for best impurity control.</li>\r\n	<li>Use of special chemical improves the cold cranking performance.</li>\r\n	<li>No scope of spillage hazard.</li>\r\n	<li>Robust design of Container and Cover makes the battery life more stronger and longer for use in rough terrain.</li>\r\n	<li>Low shelf discharge rate &amp; long shelf life.</li>\r\n	<li>High operational reliability.</li>\r\n	<li>No need to add water in life time.</li>\r\n	<li>Time saving and hassle free.</li>\r\n</ul>\r\n\r\n<p><strong>Construction</strong></p>\r\n\r\n<ul>\r\n	<li><a href=\"http://saifpowertecltd.com/ignite-pc-smf.php\">Positive Plate- Ca-Pb alloy with advanced thick grid design.</a></li>\r\n	<li>Negative Plate- Ca-Pb alloy with advanced thick grid design.</li>\r\n	<li>Separator- Low Internal Resistance Glass Matte PE GM Separator.</li>\r\n	<li>Electrolyte- High purity sulfuric acid tested by ICP-OES</li>\r\n</ul>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong>Standard Complied:</strong></p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<ul>\r\n	<li><a href=\"http://saifpowertecltd.com/ignite-pc-smf.php\">IEC</a></li>\r\n	<li>JIS</li>\r\n</ul>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong>Maintenance Tips:</strong></p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<ul>\r\n	<li><a href=\"http://saifpowertecltd.com/ignite-pc-smf.php\">Avoid flames, spark &amp; smoking near the battery.</a></li>\r\n	<li>Battery to get sufficient recharging after every discharge.</li>\r\n	<li>Use insulated tool while working on battery.</li>\r\n	<li>Use protective goggles &amp; hand gloves when working on battery.</li>\r\n	<li>Ensure the proper terminal connection so that positive terminal get connected with the positive post and negative terminal gets connected with the negative post.</li>\r\n	<li>If battery is left unused for longer period, then battery needs to be charged fully from the prescribed dealer. After charging the battery, at least 2 hours of rest time is needed for the battery to be used at load.</li>\r\n	<li>Battery can be cleaned using wet cloth but ensure positive and negative terminal doesn&rsquo;t get short by this.</li>\r\n	<li>Upper part of the battery needs to be moisture free and clean.</li>\r\n	<li>If the connecting slot of battery clamp &amp; Terminal Post get rusted then clean them using light hot water and use Vaseline or Petroleum Jelly there.</li>\r\n</ul>\r\n', NULL, NULL, NULL, 'ignite, Sealed Maintenance Free (SMF), Passenger Cars (PC)', 1, NULL),
(6, 1, 'Commercial Vehicle Battery', '<p><strong>Product Info:</strong><br />\r\nSAIF POWER CV Batteries are designed for high performance commercial vehicle with large power demands. Featuring specialist internal components, unique design features and leading technologies to deliver what motorist really want, longer life and superior performance.&nbsp;</p>\r\n\r\n<p><strong>Features and Benefit:</strong></p>\r\n\r\n<ul>\r\n	<li><a href=\"http://saifpowertecltd.com/spb-cv.php\">Special alloy composition reduces the gassing and frequent topping up of electrolyte, in turns makes the battery almost maintenance free.</a></li>\r\n	<li>Advanced grid design improves the adherence of active material makes the battery corrosion resistance and ensures longer life of battery.</li>\r\n	<li>Use of Automated Cast On Strap (COS) machine for group burning.</li>\r\n	<li>Special curing process reduces the active material shedding and increases the life of battery in rough road.</li>\r\n	<li>Thick flat plate with superior edge over competitors.</li>\r\n	<li>Manufactured with new, advanced and world class European and USA machineries.</li>\r\n	<li>First time in Bangladesh use of modern methodology of Lead testing by ICP-OES for best impurity control.</li>\r\n	<li>High porosity and very low resistance poly ethylene Separator reduces the internal resistance of battery.</li>\r\n	<li>Thicker Glass mat reduces the plate shedding and increase the life of battery.</li>\r\n	<li>Use of special chemical improves the cold cranking performance.</li>\r\n	<li>Robust design of Container and Cover makes the life of battery more stronger and longer for use in rough terrain.</li>\r\n	<li>Robust design of Rope Handle for easy lifting.</li>\r\n	<li>Low shelf discharge rate &amp; long shelf life.</li>\r\n</ul>\r\n\r\n<p><strong>Construction</strong></p>\r\n\r\n<ul>\r\n	<li><a href=\"http://saifpowertecltd.com/spb-cv.php\">Positive Plate- Ca-Pb alloy with advanced thick grid design.</a></li>\r\n	<li>Negative Plate- Ca-Pb alloy with advanced thick grid design.</li>\r\n	<li>Separator- Low Internal Resistance Glass Matte PE GM Separator.</li>\r\n	<li>Electrolyte- High purity sulfuric acid tested by ICP-OES</li>\r\n</ul>\r\n\r\n<p><strong>Application:</strong></p>\r\n\r\n<ul>\r\n	<li><a href=\"http://saifpowertecltd.com/spb-cv.php\">Bus Car</a></li>\r\n	<li>Truck</li>\r\n</ul>\r\n\r\n<p><strong>Standard Complied:</strong></p>\r\n\r\n<ul>\r\n	<li><a href=\"http://saifpowertecltd.com/spb-cv.php\">IEC</a></li>\r\n	<li>JIS</li>\r\n</ul>\r\n\r\n<p><strong>Maintenance Tips:</strong></p>\r\n\r\n<ul>\r\n	<li><a href=\"http://saifpowertecltd.com/spb-cv.php\">Avoid flames, spark &amp; smoking near the battery.</a></li>\r\n	<li>To obtain optimum service life out of the battery avoid deep discharge cycle.</li>\r\n	<li>Battery needs sufficient recharge after every discharge.</li>\r\n	<li>Use insulated tool while working on battery.</li>\r\n	<li>Use protective goggles &amp; hand gloves when working on battery.</li>\r\n	<li>Top up cell with SAIF Powertec De-Mineralized (DM) water only, never add acid.</li>\r\n	<li>Electrolyte level to maintain to the prescribed level.</li>\r\n	<li>Ensure proper terminal connection so that positive terminal get connected with the positive post and negative terminal gets connected with the negative post.</li>\r\n	<li>If battery left unused for longer period, battery need to recharge from the prescribed dealer. And after charging the battery, at least 2 hour of rest time is needed for battery to be used at load.</li>\r\n	<li>Battery can be cleaned using wet cloth but ensure positive and negative terminal doesn&rsquo;t get short by this.</li>\r\n	<li>Upper part of the battery need to be moisture free and clean.</li>\r\n	<li>If the connecting slot of battery clamp, Tray, Terminal Post get rusted then clean them using light hot water and use Vaseline or Petroleum Jelly there.</li>\r\n</ul>\r\n', NULL, NULL, NULL, 'Commercial Vehicle Battery, CV Battery', 1, NULL),
(7, 3, 'Solar Panels', '<h2>Solar Panels:</h2>\r\n\r\n<ol>\r\n	<li>Wide range of modules from 3.3 Wp to 280 Wp</li>\r\n	<li>Modules are designed to meet IEC standards</li>\r\n	<li>Modules are made of high efficiency crystalline silicon solar cells</li>\r\n	<li>Weather proof junction box with easy inter connection arrangement</li>\r\n	<li>All materials used have a proven history of reliable and stable operation in outdoor applications</li>\r\n	<li>Modules are designed for system voltage up to 1000V DC</li>\r\n</ol>\r\n', NULL, NULL, NULL, 'Solar Panels', 1, NULL),
(9, 4, 'TEKSAN Generator 22 KVA ', '<p>Diesel Generator&nbsp;</p>\r\n', NULL, NULL, NULL, '', 1, NULL),
(10, 4, 'Doosan Hand Pallet Specification Sheet.', '<p>Doosan Hand Pallet.</p>\r\n', NULL, NULL, NULL, '', 2, NULL),
(11, 5, 'Doosan Mini Excavator Specification Sheet.', '<p>Mini Excavator&nbsp;</p>\r\n', NULL, NULL, NULL, '', 1, NULL),
(12, 4, 'Doosan DX55 hydraulic excavator', '<p>hydraulic excavator</p>\r\n', NULL, NULL, NULL, '', 2, NULL),
(13, 4, 'Doosan DX80R hydraulic excavator:', '<p>&nbsp;Hydraulic excavator:</p>\r\n', NULL, NULL, NULL, '', 1, NULL),
(14, 4, 'Doosan Tracked Excavator Specification Sheet.', '<p>Tracked Excavator</p>\r\n', NULL, NULL, NULL, '', 2, NULL),
(15, 4, 'Doosan Tracked Excavator (DX220A) Specification Sheet.', '<p>Tracked Excavator</p>\r\n', NULL, NULL, NULL, '', 2, NULL),
(16, 4, 'Doosan DX300LCA Tracked Excavator', '<p>Tracked Excavator</p>\r\n', NULL, NULL, NULL, '', 2, NULL),
(17, 4, 'Doosan Tracked Excavator-DX340LCA', '<p>Tracked Excavator</p>\r\n', NULL, NULL, NULL, '', 2, NULL),
(18, 4, 'Doosan Wheel excavator-DX55W', '<p>Wheel excavator</p>\r\n', NULL, NULL, NULL, '', 2, NULL);
...
CREATE TABLE `showrooms` (
  ...
  `addr_upazila_id` int(11) DEFAULT NULL,
...
INSERT INTO `showrooms` (`id`, `addr_div_id`, `addr_dis_id`, `addr_upazila_id`, `addr_union_id`, `division_id`, `showroom_title`, `showroom_address`, `contact_name`, `contact_number`, `designation`, `email`, `cov_area`, `user_id`) VALUES
(3, 3, 1, 493, 2351, 1, 'Malibag Service Center', '1/A,Shafi Complex,(Opposite side of Century Orchid Complex),Malibag ,Dhaka ', 'Md. Monower ,Excutive,Product & Service Department', '01755543179', NULL, NULL, NULL, NULL),
(4, 2, 43, 68, 0, 1, 'Chattogram Service Center', 'H No-1719,Siddik Mansion,Shekh Mujib Road,Choumohoni,Agrabad,CTG.', 'Md.Harun-ur-Rashid', '01787684169', NULL, NULL, NULL, NULL),
(6, 2, 44, 90, 0, 1, 'Comilla', 'Dokkhin Rampura, Laksham Road, Poduyar Bazar Bissho Road, Comilla', 'Md. Shafiqul Islam', '01787684053', 2, ' shafiqul.batt@saifpowertec.com', 'Comilla, Chandpur, Noakhali, Lakshmipur, feni', NULL),
(7, 2, 45, 100, 0, 1, 'Cox\'s bazar', 'Shikdar Plaza, Muhuripara, Jhilongja, Link Road, Cox\'sbazar', 'Md. Harun Ur Rashid', '01787684169', 4, 'harun.batt@saifpowertec.com', 'Cox\'s bazar, Bandorban', NULL),
(8, 7, 54, 480, 0, 1, 'Sylhet', 'Nagar manson, (Beside Nitol Motors Service Center) Gotatikor, Kadamtoli, Dokkhin Shurma, Sylhet', 'Md. Mahfuz Alam', '01787684107', 5, '', 'Sylhet, Sunamganj, Moulvibazar, Hobiganj, B.baria', NULL),
(9, 8, 10, 217, 0, 1, 'Mymensingh', 'Bypass Mor, (Beside of Reneta Office), Dikharkanda, Mymensingh', 'Md. Khaled Fardous', '01787692511', 5, 'ferdous.batt@saifpowertec.com', 'Mymensingh, Kishorganj, Jamalpur, sherpur, Tangail', NULL),
(10, 5, 18, 330, 0, 1, 'Bogura', 'Matrichaya Vaban, (Opposite of Singar Showroom), Joypurhat, Rangpur Road,Bogura', 'Md. Sumon Mia', '01755630120 ', 4, 'sumon.batt@saifpowertec.com', 'Bogura, Naogoan, Natore, Joypurhat, Rajshahi, Chapai- nawabganj, Pabna, Sirajganj', NULL),
(11, 6, 32, 444, 0, 1, 'Rangpur', 'House No#263/1, G,L Roy road, Purbo Kamal Kachna, Rangpur', 'Md. Sumon Mia', '01755630120 ', 4, 'sumon.batt@saifpowertec.com', 'Dinajpur, Kurigram, Gaibandha, Nilfamari, Panchagarh, ', NULL),
(12, 4, 59, 0, 0, 1, ' Khulna', 'House no#207 , M,A Bari Road, Sonadanga, Khulna', 'Delwar Hasan Sayeed', '01755543182', 1, ' sumon.batt@saifpowertec.com', 'Khulna, Barishal Board, Faridpur.', NULL),
(13, 3, 1, 493, 0, 1, 'Tejgaon', ' House Number# 464, (Beside of Uttara Motors Service Center) Tejgoan, Dhaka-1208', 'Monowar ', '01755543179', 1, '', 'Dhanmondi, Gulshan, Banani & Others/ Uttara, Savar, Gazipur, Narsingdi & Others', NULL);
...
INSERT INTO `users` (`id`, `division_id`, `user_type`, `first_name`, `last_name`, `email`, `password`, `status`, `created_at`, `updated_at`) VALUES
(1, NULL, 'su', 'Super', 'Admin', 'admin@admin.com', 'e10adc3949ba59abbe56e057f20f883e', 1, NULL, NULL),
(3, 1, 'gen', 'Md.Shafiqul Islam', 'Md.Shafiqul Islam', 'shafiqul.batt@saifpowertec.com', 'd9bf6f8ca77177564d558cc00397ae10', 1, NULL, NULL),
(4, 1, 'gen', 'Md.Nasimul Hasan', 'Md.Nasimul Hasan', 'nasim@saifpowertec.com', '5ea0fa2815b295bcb6b9b50bd307991c', 1, NULL, NULL),
(5, 1, 'gen', 'Md. Monwar Hossain', 'Md. Monwar Hossain', 'monwer.batt@saifpowertec.com', 'ee01666f9e502bf88a0aaed4beec0f1d', 1, NULL, NULL),
(6, 4, 'gen', 'Md. Nasimul Haque', 'Md. Nasimul Haque', 'nasimul@maxonpowerltd.com', 'b9e0c9c3ad35c665ff97521eef517da1', 1, NULL, NULL),
(7, 4, 'gen', 'Shadman Sharar', 'Shadman Sharar', 'shadman.sharar@maxonpowerltd.com', '2c0ae92ca71c35982ab198c274de858d', 1, NULL, NULL),
(8, 1, 'gen', 'Md.Mehedi Hasan Rony', 'Md.Mehedi Hasan Rony', 'rony.batt@saifpowertec.com', '68b40f003934003e5a59316c593a98a8', 1, NULL, NULL),
(10, 4, 'gen', 'A.K Azad (Shohag) ', 'A.K Azad (Shohag) ', 'ak.azad@saifpowertec.com', 'a180430e81dff0e44d2151a740882eb8', 1, NULL, NULL),
(11, 4, 'gen', 'Papia Kahtun', 'Papia Kahtun', 'papia@saifpowertec.com', 'a91ed47d354b89871ce2bb55b3db44ae', 1, NULL, NULL),
(13, 2, 'gen', 'Engr. Sajal Kumar Biswas', 'Engr. Sajal Kumar Biswas', 'sajalkumar@saifpowertec.com', 'c630ec2e138adfab1d6713df08a8a06c', 1, NULL, NULL),
(14, 5, 'gen', 'Md.Jalil Khan Noyan', 'Md.Jalil Khan Noyan', 'jalil.khan@e-enggltd.com', '695d71d51612dc83f36c0d3d74f828e4', 1, NULL, NULL),
(15, 6, 'gen', 'Dipok Kumar Shaha', 'Dipok Kumar Shaha', 'dipak@saifpowertec.com', '8b240a4b03ea5e57e7a55cbad98b1116', 1, NULL, NULL),
(16, 2, 'gen', 'Rezaul Karim', 'Rezaul Karim', 'mrkarim@saifpowertec.com', '00e9b55de8b5c6731abba01bff56a068', 1, NULL, NULL),
(17, 6, 'gen', 'Md. Rajib Mahmud', 'Md. Rajib Mahmud', 'rajib.sppl@saifpowertec.com', 'd0b23420bd6e22ea0e19df24d028e205', 1, NULL, NULL),
(18, 6, 'gen', 'Tuhin Chowdhury', 'Tuhin Chowdhury', 'tuhin.chowdhury@saifpowertec.com', '65b208d9e2cd1d8126642961f656f14a', 1, NULL, NULL);
...
--
-- Indexes for table `addr_districts`
--
...
--
-- Indexes for table `addr_divisions`
--
ALTER TABLE `addr_divisions`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `addr_unions`
--
...
--
-- Indexes for table `addr_upazilas`
--
...
--
-- AUTO_INCREMENT for table `addr_districts`
--
ALTER TABLE `addr_districts`
...
--
-- Constraints for table `addr_districts`
--
ALTER TABLE `addr_districts`
  ADD CONSTRAINT `addr_districts_ibfk_1` FOREIGN KEY (`division_id`) REFERENCES `addr_divisions` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `addr_unions`
--
ALTER TABLE `addr_unions`
  ADD CONSTRAINT `unions_ibfk_1` FOREIGN KEY (`upazila_id`) REFERENCES `addr_upazilas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `addr_upazilas`
--
ALTER TABLE `addr_upazilas`
  ADD CONSTRAINT `addr_upazilas_ibfk_1` FOREIGN KEY (`district_id`) REFERENCES `addr_districts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
