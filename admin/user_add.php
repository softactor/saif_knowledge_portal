                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Enter Last Name" value="<?php if(isset($_SESSION['last_name']) && !empty($_SESSION['last_name'])){ echo $_SESSION['last_name']; } ?>">
                                        <?php
