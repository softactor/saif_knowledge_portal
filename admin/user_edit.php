                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="first_name" name="first_name" placeholder="Enter Name" value="<?php if(isset($userData->first_name) && !empty($userData->first_name)){ echo $userData->first_name; } ?>">
                                        <?php
