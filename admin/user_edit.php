                            ...
                            <div class="row">
                                        ...
                                        <select class="form-control" id="user_type" name="user_type">
                                            ...
                                            if (isset($groupData) && !empty($groupData)) {
                                                foreach ($groupData as $gdata) {
                                                    ?>
                                                    <option value="<?php echo $gdata->short_name; ?>"<?php if (isset($userData->user_type) && $userData->user_type == $gdata->short_name) {
                                                echo 'selected';
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="division_id" name="division_id">
                                            ...
                                            if (isset($groupData) && !empty($groupData)) {
                                                foreach ($groupData as $gdata) {
                                                    ?>
                                                    <option value="<?php echo $gdata->id; ?>"<?php if (isset($userData->division_id) && $userData->division_id == $gdata->id) {
                                                echo 'selected';
                                            } ?>><?php echo $gdata->name; ?></option>
                                                <?php
                                            }
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="first_name" name="first_name" placeholder="Enter Name" value="<?php if (isset($userData->first_name) && !empty($userData->first_name)) {
