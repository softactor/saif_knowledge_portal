                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="radio">
                                            ...
                                            <label class="radio-inline"><input type="radio" name="product_type" value="3" <?php if(isset($_SESSION['product_type']) && $_SESSION['product_type'] == 3){ echo 'checked'; } ?>>Archive</label>
                                        </div>
                                        <?php
