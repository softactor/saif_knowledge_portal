...
if (isset($_POST['CustomerInformationUpdate']) && !empty($_POST['CustomerInformationUpdate'])) {
    $customer_edit_id    = $_POST['customer_edit_id'];
    $division_id        = $_POST['division_id'];
    $user_type          = $_POST['user_type'];
    $first_name         = $_POST['first_name'];
    $last_name          = $_POST['last_name'];
    ...
    $table              = "customer_info";
    $where               = "contact='$contact' and id!=$customer_edit_id";
    $isDuplicate = isDuplicateData($table, $where);
    if (!$isDuplicate) {
        ...
        if ($error) {
            ...
            $sql            = "UPDATE customer_info set division_id='$division_id',user_type='$user_type',first_name='$first_name',last_name='$last_name',addr_division='$addr_division',addr_district='$addr_district',addr_upazila='$addr_upazila',addr_union='$addr_union',dob='$dob',email='$email',contact='$contact',is_using_product='$is_using_product',is_anyone_contact='$is_anyone_contact' where id=$customer_edit_id";
            $conn->query($sql);
            unset($_SESSION['division_id']);
            unset($_SESSION['user_type']);
            unset($_SESSION['first_name']);
    ...
    header("location: customer_information_edit.php?customer_id=$customer_edit_id");
    exit();
}
